...
import app.siemens.com.sos.MySSlFactory;

import app.siemens.com.sos.model.TaskModel;
import app.siemens.com.sos.net.WebServiceClient;

import static app.siemens.com.sos.app.siemens.com.sos.constants.Constants.TASK_URL;
...
public class MainActivity extends AppCompatActivity {
    ...
    public class SendGetRequest extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                url = new URL("https://userregistration.cfapps.io/alarm/ackAll");
